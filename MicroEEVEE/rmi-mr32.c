...
int calcDistance(int adcValue)
{
    static int sensValue[]= {760, 749, 538, 421, 350, 297, 265, 235, 217, 201, 184, 172, 164, 154};
    static int dist[]  = {7, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70};
    int i, distance=0;

    adcValue = adcValue < 154 ? 154 : adcValue;
    adcValue = adcValue > 760 ? 760 : adcValue;
