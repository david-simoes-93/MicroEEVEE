...
void ftb_execute() {
    ...
    // i was turning on myself and stopped because beacon was in front of me but there were obstacles
    if (turnedOnMyself && (obstValFront < 15 || obstValLeft < 10 || obstValRight < 10)) {
        led(0, 1);
        led(1, 1);
        led(2, 1);
        led(3, 1);
